...
namespace HotelManagement
{
    public partial class GuestForm : Form
    {
        ...
        private void btnConfrim_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    else if (Rooms.DeluxeTwinRoom > 0 && roomName == "Deluxe Twin")
                    {
                        Rooms.DeluxeTwinRoom--;
                        Rooms.SelectedRoom = "Deluxe Twin";
                        admin.UpdateLabels();
                    }
                    else if (Rooms.GrandDeluxeKingRoom > 0 && roomName == "Grand Deluxe King")
                    {
                        Rooms.GrandDeluxeKingRoom--;
                        Rooms.SelectedRoom = "Grand Deluxe King";
                        admin.UpdateLabels();
                    }
                    else if (Rooms.GrandDeluxeTwinRoom > 0 && roomName == "Grand Deluxe Twin")
                    {
                        Rooms.GrandDeluxeTwinRoom--;
                        Rooms.SelectedRoom = "Grand Deluxe Twin";
                        admin.UpdateLabels();
                    }
                    else if (Rooms.PremiumSuiteKingRoom > 0 && roomName == "Premium Suite King")
                    {
                        Rooms.PremiumSuiteKingRoom--;
                        Rooms.SelectedRoom = "Premium Suite King";
                        admin.UpdateLabels();
                    }
                    else if (Rooms.PremiumSuiteDoubleRoom > 0 && roomName == "Premium Suite Double")
                    {
                        Rooms.PremiumSuiteDoubleRoom--;
                        Rooms.SelectedRoom = "Premium Suite Double";
                        admin.UpdateLabels();
                    }
                    else if (Rooms.ExecutiveSuiteKingRoom > 0 && roomName == "Executive Suite King")
                    {
                        Rooms.ExecutiveSuiteKingRoom--;
                        Rooms.SelectedRoom = "Executive Suite King";
                        admin.UpdateLabels();
                    }
                    else if (Rooms.ExecutiveSuiteDoubleRoom > 0 && roomName == "Executive Suite Double")
                    {
                        Rooms.ExecutiveSuiteDoubleRoom--;
                        Rooms.SelectedRoom = "Executive Suite Double";
                        admin.UpdateLabels();
                    }
                    else if (Rooms.PresidentialSuiteRoom > 0 && roomName == "Presidential Suite")
                    {
                    ...
                    DialogResult addbooking = MessageBox.Show("do you want to add room?", "Add Booking", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                    if (addbooking == DialogResult.Cancel)
                    {
        ...
        private void checkinpicker_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Cannot proceed double check your reservation date");
            }
            else
            {
        ...
        public void CalculateDays()
        {
            ...
            int DaysDiff = (checkout - checkin).Days;
        ...
        private void btnDeluxeKing_Click(object sender, EventArgs e)
        {
            if (lblNumAdult.Text != "0" && lblCheckIn.Text != "-" && lblCheckOut.Text != "-")
            {
                ...
                lblPriceRoom.Text = $"{rooms.DeluxeKing}";
                GetGuest();
                CalculateDays();
        ...
        private void btnDeluxeTwin_Click(object sender, EventArgs e)
        {
            ...
            if (lblNumAdult.Text != "0" && lblCheckIn.Text != "-" && lblCheckOut.Text != "-")
            {
                ...
                lblPriceRoom.Text = $"{rooms.DeluxeTwin}";
                GetGuest();
                CalculateDays();
                roomName = lblNameRoom.Text; 
        ...
        private void btnGrandDeluxeKing_Click(object sender, EventArgs e)
        {
            if (lblNumAdult.Text != "0" && lblCheckIn.Text != "-" && lblCheckOut.Text != "-")
            {
                ...
                lblPriceRoom.Text = $"{rooms.GrandDeluxeKing}";
                GetGuest();
                CalculateDays();
        ...
        private void btnGradnDeluxeDouble_Click(object sender, EventArgs e)
        {
            if (lblNumAdult.Text != "0" && lblCheckIn.Text != "-" && lblCheckOut.Text != "-")
            {
                ...
                lblPriceRoom.Text = $"{rooms.GrandDeluxeDouble}";
                GetGuest();
                CalculateDays();
        ...
        private void btnPremiumSuiteKing_Click(object sender, EventArgs e)
        {
            if (lblNumAdult.Text != "0" && lblCheckIn.Text != "-" && lblCheckOut.Text != "-")
            {
                ...
                lblPriceRoom.Text = $"{rooms.PremiumSuiteKing}";
                GetGuest();
                CalculateDays();
        ...
        private void btnPremuimSuiteDouble_Click(object sender, EventArgs e)
        {
            if (lblNumAdult.Text != "0" && lblCheckIn.Text != "-" && lblCheckOut.Text != "-")
            {
                ...
                lblPriceRoom.Text = $"{rooms.PremiumSuiteDouble}";
                GetGuest();
                CalculateDays();
        ...
        private void ExecutiveSuiteKing_Click(object sender, EventArgs e)
        {
            if (lblNumAdult.Text != "0" && lblCheckIn.Text != "-" && lblCheckOut.Text != "-")
            {
                ...
                lblPriceRoom.Text = $"{rooms.ExecutiveSuiteKing}";
                GetGuest();
                CalculateDays();
        ...
        private void btnExecutiveSuiteDouble_Click(object sender, EventArgs e)
        {
            if (lblNumAdult.Text != "0" && lblCheckIn.Text != "-" && lblCheckOut.Text != "-")
            {
                ...
                lblPriceRoom.Text = $"{rooms.ExecutiveSuiteDouble}";
                GetGuest();
                CalculateDays();
        ...
        private void btnRemoveRoom_Click(object sender, EventArgs e)
        {
            ...
            else if (Rooms.SelectedRoom == "Grand Deluxe Twin")
            {
                Rooms.GrandDeluxeTwinRoom++;
            }
        ...
        private void Dback_Click(object sender, EventArgs e)
        {
            ...
            {
                if (openform.Name == "Dashboard") // Replace with the actual form name
                {
                    isFormOpen = true;
